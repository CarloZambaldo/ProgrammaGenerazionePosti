...
"""-------------------------------------------"""
"""--------------VERSIONE 3.9.3---------------"""
"""------MODIFICATO IL 17 FEBBRAIO 2017-------"""
"""
...
### ERRORI
    ...
    def CREAVV(self):
        ...
        Label(self.CREATA, text="Creazione file posti.txt avvenuta con successo.", fg = 'green', font=('times', 30)).grid(row=0, column=0)
        Button(self.CREATA, text = 'OK', fg = 'red', relief="groove",font=('times', 16, "bold"),command = lambda: self.CREATA.destroy()).grid(row = 1, column = 1, stick = W)  
...
#######
    ...
    def info(self):
        ...
        Label(self.informa, text="Files: ", fg = 'blue',font=('times', 16)).grid(row=5, column=0,stick = E)
