...
Programma che crea a random i posti,
   input necessari: - Numero studenti
    ...
    funzioni aggiuntive: - Crea un documento .txt per salvare una disposizione
                  ...
                  (BETA) - Possibilita' di aggiungere una condizione (es. studente1 non può essere vicino a studente2)
...
class posti:
    ...
    def begin(self):
        ...
        self.e1 = Entry(self.menu, textvariable=1)
        self.e2 = Entry(self.menu, textvariable=2)
        self.e3 = Entry(self.menu, textvariable=3)
        ...
        Button(self.menu, text = 'NEXT', fg = 'blue', relief="groove",font=('times', 16, "bold"),command = lambda: self.avanti()).grid(row = 5, column = 0, stick = W)
        Button(self.menu, text = 'INFO', fg = 'black', relief="groove", font=('times', 14, "bold"),command = lambda: self.info()).grid(row = 5, column = 2, stick = W)
        Button(self.menu, text = 'ADVANCED', fg = 'black', relief="groove",font=('times', 16, "bold"),command = lambda: self.ADV()).grid(row = 5, column = 1, stick = W)
    ...
    def ADV(self):
        ...
        self.A1 = Entry(self.ADVANCED, textvariable=4)
        self.A1.grid(row=0, column=1, ipadx = 1)
        Button(self.ADVANCED, text = 'CLOSE', fg = 'red', relief="groove",font=('times', 14, "bold"),command = lambda: self.ADVANCED.destroy()).grid(row = 0, column = 2, stick = W)
        self.ADVANCED.pack()
...
### ERRORI
    ...
    def PSERR(self):
        ...
        Label(self.PASS, text="Password errata", fg = 'red', font=('times', 30)).grid(row=0, column=0)
...
###########
    ...
    def OpenAll(self):
        ...
        try:
            ...
            Nomi.close()
            Label(self.Studenti, text=str(StudentiText), fg = 'black',font=('times', 15)).grid(row=1, column=0,stick = E)
        except:
            Label(self.Studenti, text="File inesistente.", fg = 'black',font=('times', 15)).grid(row=1, column=0,stick = E)
        self.Studenti.pack()
        ...
        try:
            ...
            Posti.close()
            Label(self.Disposizione, text=str(PostiText), fg = 'black',font=('times', 15)).grid(row=1, column=0,stick = E)
        except:
            Label(self.Disposizione, text="File inesistente.", fg = 'black',font=('times', 15)).grid(row=1, column=0,stick = E)
        self.Disposizione.pack()
        
        self.CloseAll = Frame(self.OA)
        Button(self.CloseAll, text = 'Close All', fg = 'blue', relief="groove", font=('times', 16, "bold"), command = lambda: self.ClAll()).grid(row =0, column =0, stick = W)
        self.CloseAll.pack()
